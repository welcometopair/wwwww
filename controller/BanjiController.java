...
public class BanjiController {
    ...
    public R count(@RequestParam Map<String, Object> params,BanjiEntity banji, HttpServletRequest request){
        EntityWrapper<BanjiEntity> ew = new EntityWrapper<BanjiEntity>();
        int count = banjiService.selectCount(MPUtil.sort(MPUtil.between(MPUtil.likeOrEq(ew, banji), params), params));
