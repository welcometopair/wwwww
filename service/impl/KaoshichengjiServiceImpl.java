...
public class KaoshichengjiServiceImpl extends ServiceImpl<KaoshichengjiDao, KaoshichengjiEntity> implements KaoshichengjiService {
    ...
    @Override
    public List<Map<String, Object>> xueshengxingmingshifouhegeTypeStat(Map<String, Object> params, Wrapper<KaoshichengjiEntity> wrapper) {
        return baseMapper.xueshengxingmingshifouhegeTypeStat(params, wrapper);
    }
